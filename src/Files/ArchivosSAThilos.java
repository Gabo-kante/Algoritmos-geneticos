...
import SAThilos.Individuo;
import SAThilos.Instancias;
...
public class ArchivosSAThilos {
    ...
    public static void escribir(ArrayList<Individuo> poblacion) {
        ...
        try {
            ...
            Logger.getLogger(ArchivosSAThilos.class.getName()).log(Level.SEVERE, null, ex);
