...
import SATbooleana.Individuo;
import SATbooleana.Instancias;
 ...
 * @author gabri
 */
public class ArchivosSATbooleana {
    ...
    public static void escribir(ArrayList<Individuo> poblacion) {
        ...
        try {
            ...
            Logger.getLogger(ArchivosSATbooleana.class.getName()).log(Level.SEVERE, null, ex);
