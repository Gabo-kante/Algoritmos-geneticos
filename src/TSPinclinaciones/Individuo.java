...
public class Individuo {
    ...
    public Individuo(int ciudadInicial, int nCiudades, int limiteInclinacion) {
        ...
        genotipo[0] = ciudadInicial;
        this.distanciasCaminos = HerramientasTSPIncli.inicializaCaminos(nCiudades);
        HerramientasTSPIncli.generarInclinaciones(nCiudades, limiteInclinacion);
        this.inclinaciones = HerramientasTSPIncli.getInclinaciones().clone();
